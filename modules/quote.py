...
def trending(phenny, input):
    ...
    ignore_list = [
        ...
        "been", "but", "by", "call", "can", "come", "could", "day", "did",
        "didn't", "do", "down", "each", "find", "first", "for", "from", "get",
        "!give", "go", "!grab", "had", "has", "have", "he", "her", "him", "his",
        "how", "i", "if", "i'm", "in", "into", "is", "it", "it's", "its",
        "i've", "just", "like", "lol", "long", "look", "made", "make", "many",
        "may", "me", "more", "my", "no", "!nocontext", "not", "now", "number",
        "of", "oh", "oil", "on", "one", "or", "other", "out", "part", "people",
        "!points", "!quote", "!random", "said", "see", "she", "should",
        "shouldn't", "so", "some", "than", "that", "that's", "thats", "the",
        "their", "them", "then", "there", "these", "they", "this", "time", "to",
        "!trending", "two", "up", "use", "was", "water", "way", "!wc", "we",
        "were", "what", "when", "which", "who", "will", "with", "word", "would",
        "write", "\x01action", "you", "your", "you're",
    ]
